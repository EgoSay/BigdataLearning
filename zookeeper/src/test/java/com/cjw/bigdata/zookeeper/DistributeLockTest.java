package com.cjw.bigdata.zookeeper;
...
/**
 * 利用 curator 实现分布式锁
 * refer: https://www.jianshu.com/p/6618471f6e75,  https://www.jianshu.com/p/31335efec309
 * @author chenjiawei
 * @version 1.0
...
public class DistributeLockTest {
    ...
    public void init() throws Exception {
        ...
        String connectString = new TestingServer().getConnectString();
        // 重试策略
        // 初始休眠时间为 1000ms, 最大重试次数为 3
        RetryPolicy retry = new ExponentialBackoffRetry(1000, 3);

        // 创建客户端, 60000(ms)为 session 超时时间, 15000(ms)为链接超时时间
